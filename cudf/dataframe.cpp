...
namespace pd {
    ...
    GPUDataframe::GPUDataframe(std::shared_ptr<arrow::Array> const &index,
                               std::shared_ptr<arrow::RecordBatch> const &recordBatch) : GPUSeries() {
    ...
    GPUDataframe GPUDataframe::binary_operator(GPUDataframe const &other, cudf::binary_operator op) const {
        ...
        auto isIndexNotEqualColumn = cudf::any(cudf::binary_operation(
                ...
                cudf::data_type(cudf::type_id::BOOL8))->view());
